    ...
    <React.Fragment>
      ...
      <div>
        ...
        <p style={{marginTop: "40px"}}>
          Currently we are trying to finish up heroes with their Soul Weapons, skins and voicelines. All <Link to="heroes"><BlueLink>heroes</BlueLink></Link> with their skill and UT/UW data and <Link to="artifacts"><BlueLink>artifacts</BlueLink></Link> are available.
        </p>
      </div>
    </React.Fragment>
  );
